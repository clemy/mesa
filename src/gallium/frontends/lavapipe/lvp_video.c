...
VKAPI_ATTR void VKAPI_CALL
lvp_CmdBeginVideoCodingKHR(VkCommandBuffer commandBuffer, const VkVideoBeginCodingInfoKHR *pBeginInfo)
{
   VK_FROM_HANDLE(lvp_cmd_buffer, cmd_buffer, commandBuffer);
   VK_FROM_HANDLE(lvp_video_session, vid, pBeginInfo->videoSession);
   VK_FROM_HANDLE(lvp_video_session_params, params, pBeginInfo->videoSessionParameters);

   /* TODO: shouldn't we queue this somehow or do we copy it into other commands? */
...
VKAPI_ATTR void VKAPI_CALL
lvp_CmdControlVideoCodingKHR(VkCommandBuffer commandBuffer, const VkVideoCodingControlInfoKHR *pCodingControlInfo)
{
   //VK_FROM_HANDLE(lvp_cmd_buffer, cmd_buffer, commandBuffer);

   /* TODO: Queue a command */
}

void
lvp_CmdEndVideoCodingKHR(VkCommandBuffer commandBuffer, const VkVideoEndCodingInfoKHR *pEndCodingInfo)
{
   VK_FROM_HANDLE(lvp_cmd_buffer, cmd_buffer, commandBuffer);
...
VKAPI_ATTR void VKAPI_CALL
lvp_CmdEncodeVideoKHR(VkCommandBuffer commandBuffer, const VkVideoEncodeInfoKHR *pEncodeInfo)
{
   //VK_FROM_HANDLE(lvp_cmd_buffer, cmd_buffer, commandBuffer);
